...
1. [Section 9.2: Practice with surprisal and entropy](#problem-1-practice-with-surprisals-and-entropies)
2. [Section 9.2: Entropy in different bases](#problem-2-entropies-in-different-bases)
3. [Section 9.2: Independence and entropy](#problem-3-independence-and-entropy)
4. [Section 9.2: Uncertain draws](#problem-4-uncertain-draws)
5. [Section 9.2: Differential entropy](#problem-5-differential-entropy)
6. [Section 9.3: Practice with KL divergence](#problem-6-practice-with-kl-divergence)
7. [Section 9.3: Differential KL divergence](#problem-7-differential-kl-divergence)
